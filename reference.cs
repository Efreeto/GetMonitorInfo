/* From https://stackoverflow.com/a/66160049/2680660 */
...
private struct DISPLAYCONFIG_DEVICE_INFO_HEADER // 20
{
    public DISPLAYCONFIG_DEVICE_INFO_TYPE type; // 4
    public int size;    // 4
...
private struct DISPLAYCONFIG_SOURCE_DEVICE_NAME // 84
{
...
[StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
private struct DISPLAYCONFIG_TARGET_DEVICE_NAME // 420
{
    public DISPLAYCONFIG_DEVICE_INFO_HEADER header; // 20
    public DISPLAYCONFIG_TARGET_DEVICE_NAME_FLAGS flags;    // 4
    public DISPLAYCONFIG_VIDEO_OUTPUT_TECHNOLOGY outputTechnology;  // 4
    public ushort edidManufactureId;    // 2
    public ushort edidProductCodeId;    // 2
    public uint connectorInstance;      // 4
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 64)]
    public string monitorFriendlyDeviceName;    // 128
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 128)]
    public string monitorDevicePath;   // 256
}
